...
@section('title', 'Rehabilitasi Sosial Lanjut Usia Telantar di Dalam Panti')

@section('content')
<div class="container my-5">
    <h2 class="text-center mb-4">Dokumen: Rehabilitasi Sosial Lanjut Usia Telantar di Dalam Panti</h2>
    <div class="row justify-content-center">
        <div class="col-lg-10">
            @php
                // !!! GANTI DENGAN NAMA FILE PDF YANG SESUAI UNTUK DOKUMEN INI !!!
                // Contoh nama file yang disederhanakan:
                $fileName = '1.REHABILITASI_SOSIAL_DASAR_LANJUT_USIA_TELANTAR_DI_DALAM_PANTI.pdf'; 
