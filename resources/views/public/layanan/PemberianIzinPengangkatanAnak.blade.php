...
@section('title', 'Pemberian Izin Pengangkatan Anak')

@section('content')
<div class="container my-5">
    <h2 class="text-center mb-4">Dokumen: Pemberian Izin Pengangkatan Anak</h2>
    <div class="row justify-content-center">
        <div class="col-lg-10">
            @php
                // !!! GANTI DENGAN NAMA FILE PDF YANG SESUAI UNTUK DOKUMEN INI !!!
                $fileName = '8.PEMBERIAN_IZIN_ENGANGKATAN_ANAK.pdf'; 
